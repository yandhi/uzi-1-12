 ...
 * @since 8/29/2021
 */
public class WatermarkComponent extends AbstractComponent {

    public WatermarkComponent(GuiManager guiManager, Rectangle renderPosition) {
        super("", guiManager, renderPosition);
    }
}
